...
const analyzeQuery = require('./resolve_query');
...
const Model = function (schema, index, model_name, options) {
    ...
    const schema_analyzer = analyzeSchema(schema, {index: index}); //TODO: event loop!
     ...
     * @returns {string}
     */
    this.getIndexKey = (data) => { //TODO: with callback? event loop!
    ...
    this.find = (query, callback) => {
        analyzeQuery(query, schema_analyzer)
            .then((analyzed_query) => {
