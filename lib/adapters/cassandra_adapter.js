    ...
    this.find = (query_analyzer, callback) => {
        ...
        query_analyzer.keys().forEach((key) => {
            ...
            if (array) {
                ...
                if (left)
                    rm = query_analyzer.match; //TODO: we have to restructure that. we might go for approximations... or we need in query_analyzer something like 'has expression' or the expression is empty or filled... so we can ask for expression here
                else
