...
class CassandraAdapter {
    ...
    constructor(getIndexId, schema_definition, options){ //TODO pass a function schema definition. that's better
        ...
        if (!this._table_ensured){
            this._ensureKeyspace((err, keyspace) => {
                ...
                let query = "CREATE TABLE IF NOT EXISTS " + keyspace + "." + this._model_name + " ("
                    ...
                    + ", PRIMARY KEY(" + index_keys.join(', ') + "));"; //TODO: index must be in order of index array here!
